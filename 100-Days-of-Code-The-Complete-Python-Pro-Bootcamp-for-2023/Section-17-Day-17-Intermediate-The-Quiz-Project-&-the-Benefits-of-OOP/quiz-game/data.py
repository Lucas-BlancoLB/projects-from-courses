...
'''' https://opentdb.com/api_config.php  |number of questions: n | category: any | difficulty: any | Type: True / False | encoding: Default (JSON)  '''
question_data_2 = {"response_code": 0,
                   "results": [
